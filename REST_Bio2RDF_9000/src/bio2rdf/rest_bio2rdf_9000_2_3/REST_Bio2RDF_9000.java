...
package bio2rdf.rest_bio2rdf_9000_2_3;
...
public class REST_Bio2RDF_9000 implements TalendJob {
	...
	private final String jobVersion = "2.3";
	...
	public static class nsid_virtuosoStruct implements
			routines.system.IPersistableRow<nsid_virtuosoStruct> {
		final static byte[] commonByteArrayLock_BIO2RDF_REST_Bio2RDF_9000 = new byte[0];
		static byte[] commonByteArray_BIO2RDF_REST_Bio2RDF_9000 = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(nsid_virtuosoStruct other) {
	...
	public static class nsid_acceptStruct implements
			routines.system.IPersistableRow<nsid_acceptStruct> {
		final static byte[] commonByteArrayLock_BIO2RDF_REST_Bio2RDF_9000 = new byte[0];
		static byte[] commonByteArray_BIO2RDF_REST_Bio2RDF_9000 = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(nsid_acceptStruct other) {
	...
	public void tRESTRequest_1_LoopProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				nsid_virtuosoStruct nsid_virtuoso = new nsid_virtuosoStruct();
				row11Struct row11 = new row11Struct();
				copyOfout1Struct copyOfout1 = new copyOfout1Struct();
				copyOfout1Struct row27 = copyOfout1;
				row28Struct row28 = new row28Struct();
				nsid_acceptStruct nsid_accept = new nsid_acceptStruct();
				...
				try {
					...
					int NB_ITERATE_tSparqlSelectRequest_4 = 0; // for statistics

					ok_Hash.put("tFlowToIterate_4", false);
					start_Hash.put("tFlowToIterate_4",
							System.currentTimeMillis());
					...
					int NB_ITERATE_tSparqlSelectRequest_5 = 0; // for statistics

					ok_Hash.put("tFlowToIterate_14", false);
					start_Hash.put("tFlowToIterate_14",
							System.currentTimeMillis());
					...
					nsid_virtuosoStruct nsid_virtuoso_tmp = new nsid_virtuosoStruct();
					nsid_acceptStruct nsid_accept_tmp = new nsid_acceptStruct();
					// ###############################
					...
					if (index != null) {
						...
						start_Hash.put("tFixedFlowInput_6",
								System.currentTimeMillis());
						...
						StringBuilder result_tFixedFlowInput_6 = new StringBuilder();
						result_tFixedFlowInput_6
								.append("PCFET0NUWVBFIGh0bWwgUFVCTElDICItLy9XM0MvL0RURCBYSFRNTCtSREZhIDEuMC8vRU4iICJo");
						result_tFixedFlowInput_6
								.append("dHRwOi8vd3d3LnczLm9yZy9NYXJrVXAvRFREL3hodG1sLXJkZmEtMS5kdGQiPg0KPGh0bWwgdmVy");
						result_tFixedFlowInput_6
								.append("c2lvbj0iWEhUTUwrUkRGYSAxLjAiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8xOTk5L3hodG1s");
						result_tFixedFlowInput_6
								.append("Ij4NCjxoZWFkPg0KCTx0aXRsZT5CaW8yUkRGPC90aXRsZT4NCgk8bGluayBocmVmPSJodHRwOi8v");
						result_tFixedFlowInput_6
								.append("bS5iaW8ycmRmLm9yZy9pbWFnZS9iaW8ycmRmLnBuZyIgcmVsPSJzaG9ydGN1dCBpY29uIiAvPg0K");
						result_tFixedFlowInput_6
								.append("PC9oZWFkPg0KPGJvZHk+DQo8dGFibGUgc3VtbWFyeT0iIj4NCgk8dGJvZHk+DQoJCTx0cj4NCgkJ");
						result_tFixedFlowInput_6
								.append("CTx0ZCB3aWR0aD0iMjAlIj48YSBocmVmPSJodHRwOi8vYmlvaW5mb3JtYXRpcXVlLnVsYXZhbC5j");
						result_tFixedFlowInput_6
								.append("YS90ZWFtLyI+PGltZyBhbHQ9InVsYXZhbCIgaGVpZ2h0PSI4MCIgc3JjPSJodHRwOi8vd3d3LnVs");
						result_tFixedFlowInput_6
								.append("YXZhbC5jYS9BbC9maWNoaWVycy9VTC5qcGciIC8+PC9hPjwvdGQ+DQoJCQk8dGQgd2lkdGg9IjYw");
						result_tFixedFlowInput_6
								.append("JSI+Jm5ic3A7PC90ZD4NCgkJCTx0ZCB3aWR0aD0iMjAlIj48YSBocmVmPSJodHRwOi8vZHVtb250");
						result_tFixedFlowInput_6
								.append("aWVybGFiLmNvbS8iPjxpbWcgYWx0PSJjYXJsZXRvbiIgaGVpZ2h0PSI4MCIgc3JjPSJodHRwOi8v");
						result_tFixedFlowInput_6
								.append("bS5iaW8ycmRmLm9yZy9pbWFnZS9jYXJsZXRvbi5wbmciIC8+PC9hPjwvdGQ+DQoJCTwvdHI+DQoJ");
						result_tFixedFlowInput_6
								.append("PC90Ym9keT4NCjwvdGFibGU+DQoNCjxkaXYgaWQ9ImFsbCI+DQo8ZGl2IGlkPSJtYWluIiBzdHls");
						result_tFixedFlowInput_6
								.append("ZT0idGV4dC1hbGlnbjogY2VudGVyOyI+DQo8ZGl2IHN0eWxlPSJoZWlnaHQ6IDIwJTsiPiZuYnNw");
						result_tFixedFlowInput_6
								.append("OzwvZGl2Pg0KPGltZyBhbHQ9IkJpbzJSREYiIHNyYz0iaHR0cDovL20uYmlvMnJkZi5vcmcvaW1h");
						result_tFixedFlowInput_6
								.append("Z2UvYmlvMnJkZi5wbmciIC8+DQo8ZGl2IGlkPSJtYWluIiBzdHlsZT0idGV4dC1hbGlnbjogY2Vu");
						result_tFixedFlowInput_6
								.append("dGVyOyI+DQo8aDE+TGlua2VkIERhdGEgSHViIGZvciB0aGUgTGlmZSBTY2llbmNlczwvaDE+DQo8");
						result_tFixedFlowInput_6
								.append("L2Rpdj4NCg0KPGZvcm0gYWN0aW9uPSIvbm9zY3JpcHQvIiBtZXRob2Q9IkdFVCIgbmFtZT0iZm9y");
						result_tFixedFlowInput_6
								.append("bTEiIG9uc3VibWl0PSJkb2N1bWVudC5sb2NhdGlvbj0nL3BhZ2UvJytmb3JtMS5pZC52YWx1ZSsn");
						result_tFixedFlowInput_6
								.append("JztyZXR1cm4gZmFsc2U7Ij48c2VsZWN0IG5hbWU9InNlbGVjdHZhbHVlIiBvbmNoYW5nZT0iZm9y");
						result_tFixedFlowInput_6
								.append("bTEuaWQudmFsdWUgPSB0aGlzLm9wdGlvbnNbdGhpcy5zZWxlY3RlZEluZGV4XS52YWx1ZTsiIHNp");
						result_tFixedFlowInput_6
								.append("emU9IjEiPjxvcHRpb24gc2VsZWN0ZWQ9InNlbGVjdGVkIiB2YWx1MTFlPSIiPlNlbGVjdCBhbiBJ");
						result_tFixedFlowInput_6
								.append("RCBleGFtcGxlPC9vcHRpb24+PG9wdGlvbiB2YWx1ZT0iZ286MDAzMjI4MyI+cGxhc3RpZCBhY2V0");
						result_tFixedFlowInput_6
								.append("YXRlIENvQS10cmFuc2ZlcmFzZSBjb21wbGV4IFtnbzowMDMyMjgzXTwvb3B0aW9uPjxvcHRpb24g");
						result_tFixedFlowInput_6
								.append("dmFsdWU9ImNoZWJpOjE2NTI2Ij5jYXJib24gZGlveGlkZSBbY2hlYmk6MTY1MjZdPC9vcHRpb24+");
						result_tFixedFlowInput_6
								.append("PG9wdGlvbiB2YWx1ZT0ib21pbTo2MDIwODAiPlBBR0VUIERJU0VBU0UgT0YgQk9ORTsgUERCIFtv");
						result_tFixedFlowInput_6
								.append("bWltOjYwMjA4MF08L29wdGlvbj48b3B0aW9uIHZhbHVlPSJnZW5laWQ6MzcxOTEiPlNlcm90b25p");
						result_tFixedFlowInput_6
								.append("biByZWNlcHRvciAxQiAoc3ltYm9sOjUtSFQxQix0YXhvbjo3MjI3KSBbZ2VuZWlkOjM3MTkxXTwv");
						result_tFixedFlowInput_6
								.append("b3B0aW9uPjxvcHRpb24gdmFsdWU9InRheG9ub215Ojk2MDYiPkhvbW8gU2FwaWVucyBbdGF4b246");
						result_tFixedFlowInput_6
								.append("OTYwNl08L29wdGlvbj48b3B0aW9uIHZhbHVlPSJkcnVnYmFuazpEQjAwMTQzIj5HbHV0YXRoaW9u");
						result_tFixedFlowInput_6
								.append("ZSBbZHJ1Z2Jhbms6REIwMDE0M108L29wdGlvbj48b3B0aW9uIHZhbHVlPSJnbzowMDA1ODEzIj5D");
						result_tFixedFlowInput_6
								.append("ZW50cm9zb21lIFtnbzowMDA1ODEzXTwvb3B0aW9uPjxvcHRpb24gdmFsdWU9InBoYXJtZ2tiOlBB");
						result_tFixedFlowInput_6
								.append("MTI4NDA2OTU2Ij5mbHVvcm91cmFjaWwgW3BoYXJtZ2tiOlBBMTI4NDA2OTU2XTwvb3B0aW9uPjxv");
						result_tFixedFlowInput_6
								.append("cHRpb24gdmFsdWU9ImFmZnltZXRyaXg6MTQxNTc2NV9hdCI+cHJvYmVzZXQgMTQxNTc2NV9hdCBv");
						result_tFixedFlowInput_6
								.append("biBHZW5lQ2hpcCBIVCBNb3VzZSBHZW5vbWUgTUctNDMwQiAoTXVzIG11c2N1bHVzKSBbYWZmeW1l");
						result_tFixedFlowInput_6
								.append("dHJpeDoxNDE1NzY1X2F0XTwvb3B0aW9uPjxvcHRpb24gdmFsdWU9InNnZDpTMDAwMDA2MTY5Ij5H");
						result_tFixedFlowInput_6
								.append("QUw0IFtzZ2Q6UzAwMDAwNjE2OV08L29wdGlvbj48b3B0aW9uIHZhbHVlPSJuZGM6MDc4MS0xMDM0");
						result_tFixedFlowInput_6
								.append("Ij5UcmlmbHVvcGVyYXppbmUgSHlkcm9jaGxvcmlkZSAoNSBtZy8xIHRyaWZsdW9wZXJhemluZSBo");
						result_tFixedFlowInput_6
								.append("eWRyb2NobG9yaWRlKSBbbmRjOjA3ODEtMTAzNF08L29wdGlvbj48b3B0aW9uIHZhbHVlPSJob21v");
						result_tFixedFlowInput_6
								.append("bG9nZW5lOjgyNjAiPkhvbW9sb0dlbmUgR3JvdXAgODI2MCBbaG9tb2xvZ2VuZTo4MjYwXTwvb3B0");
						result_tFixedFlowInput_6
								.append("aW9uPjxvcHRpb24gdmFsdWU9ImRpcDpESVAtNTcyNjZFIj4zIGNvbXBvbmVudCBjb21wbGV4IGlk");
						result_tFixedFlowInput_6
								.append("ZW50aWZpZWQgYnkgcHJvdGVpbiBjcm9zcy1saW5raW5nIHdpdGggYSBiaWZ1bmN0aW9uYWwgcmVh");
						result_tFixedFlowInput_6
								.append("Z2VudCBbZGlwOkRJUC01NzI2NkVdPC9vcHRpb24+PG9wdGlvbiB2YWx1ZT0iaGduYzoyNDA4NiI+");
						result_tFixedFlowInput_6
								.append("QVBPQkVDMSBjb21wbGVtZW50YXRpb24gZmFjdG9yIFtoZ25jOjI0MDg2XTwvb3B0aW9uPjxvcHRp");
						result_tFixedFlowInput_6
								.append("b24gdmFsdWU9ImludGVycHJvOklQUjAwOTQwNyI+VmlyYWwgcG9seXByb3RlaW4sIHBhcmVjaG92");
						result_tFixedFlowInput_6
								.append("aXJ1cyBQM0IgKFZQUF9wYXJlY2hvdmlyX1AzQikgRG9tYWluIFtpbnRlcnBybzpJUFIwMDk0MDdd");
						result_tFixedFlowInput_6
								.append("PC9vcHRpb24+IDwvc2VsZWN0PiA8aW5wdXQgbWF4bGVuZ3RoPSIxNTAiIG5hbWU9ImlkIiBzaXpl");
						result_tFixedFlowInput_6
								.append("PSIzMCIgdHlwZT0idGV4dCIgLz4gPGlucHV0IHR5cGU9InN1Ym1pdCIgdmFsdWU9IlN1Ym1pdCIg");
						result_tFixedFlowInput_6
								.append("Lz4mbmJzcDs8L2Zvcm0+DQo8L2Rpdj4NCg0KPGRpdiBpZD0iZm9vdGVyIiBzdHlsZT0idGV4dC1h");
						result_tFixedFlowInput_6
								.append("bGlnbjogY2VudGVyOyI+DQo8dWwgc3R5bGU9Imxpc3Qtc3R5bGUtdHlwZTogbm9uZTsiPg0KCTxs");
						result_tFixedFlowInput_6
								.append("aT4NCgk8aDM+PGEgaHJlZj0iL3Rlc3QiPlJFU1Qgc2VydmljZXMgdGVzdCBwYWdlPC9hPjwvaDM+");
						result_tFixedFlowInput_6
								.append("DQoJPC9saT4NCgk8bGk+LjwvbGk+DQoJPGxpPkdldCBtb3JlIGluZm9ybWF0aW9uIGFib3V0IGF2");
						result_tFixedFlowInput_6
								.append("YWlsYWJsZSBCaW8yUkRGIGRhdGFzZXRzIDxhIGhyZWY9Imh0dHBzOi8vZ2l0aHViLmNvbS9iaW8y");
						result_tFixedFlowInput_6
								.append("cmRmL2JpbzJyZGYtc2NyaXB0cy93aWtpIj5oZXJlPC9hPi48L2xpPg0KCTxsaT5SZWxlYXNlIDIg");
						result_tFixedFlowInput_6
								.append("ZGF0YXNldHMgbGlzdCA8YSBocmVmPSJodHRwOi8vZG93bmxvYWQuYmlvMnJkZi5vcmcvcmVsZWFz");
						result_tFixedFlowInput_6
								.append("ZS8yL3JlbGVhc2UuaHRtbCI+aGVyZTwvYT48L2xpPg0KCTxsaT4mbmJzcDs8L2xpPg0KCTxsaT5E");
						result_tFixedFlowInput_6
								.append("b3dubG9hZCA6IDxhIGhyZWY9Imh0dHBzOi8vc291cmNlZm9yZ2UubmV0L3Byb2plY3RzL2JpbzJy");
						result_tFixedFlowInput_6
								.append("ZGYvIj5CaW8yUkRGIHZlcnNpb24gMi4wIFJFU1Qgc2VydmVyPC9hPiwgPGEgaHJlZj0iaHR0cHM6");
						result_tFixedFlowInput_6
								.append("Ly9zb3VyY2Vmb3JnZS5uZXQvcHJvamVjdHMvYmlvMnJkZi9maWxlcy90YWxlbmQ0YmlvMnJkZi8i");
						result_tFixedFlowInput_6
								.append("PlRhbGVuZCBmb3IgQmlvMlJERjwvYT4sIDxhIGhyZWY9Imh0dHBzOi8vc291cmNlZm9yZ2UubmV0");
						result_tFixedFlowInput_6
								.append("L3Byb2plY3RzL2JpbzJyZGYvZmlsZXMvdGFsZW5kNHN3LyI+VGFsZW5kIGZvciBTZW1hbnRpYyBX");
						result_tFixedFlowInput_6
								.append("ZWI8L2E+LjwvbGk+DQo8L3VsPg0KPC9kaXY+DQo8L2Rpdj4NCg0KPGRpdiBpZD0iZm9vdGVyIiBz");
						result_tFixedFlowInput_6
								.append("dHlsZT0idGV4dC1hbGlnbjogY2VudGVyOyI+UG93ZXJlZCBieSA8YSBocmVmPSJodHRwOi8vd3d3");
						result_tFixedFlowInput_6
								.append("LnRhbGVuZC5jb20vcHJvZHVjdHMvZXNiIj5UYWxlbmQgRVNCPC9hPiBhbmQgPGEgaHJlZj0iaHR0");
						result_tFixedFlowInput_6
								.append("cDovL3ZpcnR1b3NvLm9wZW5saW5rc3cuY29tL2RhdGFzcGFjZS9kb2MvZGF2L3dpa2kvTWFpbi8i");
						result_tFixedFlowInput_6
								.append("PlZpcnR1b3NvIE9wZW4tU291cmNlIEVkaXRpb248L2E+PC9kaXY+DQoNCjx0YWJsZSBzdW1tYXJ5");
						result_tFixedFlowInput_6
								.append("PSIiPg0KCTx0Ym9keT4NCgkJPHRyPg0KCQkJPHRkIHdpZHRoPSIyMCUiPg0KCQkJPGgzPjxhIGhy");
						result_tFixedFlowInput_6
								.append("ZWY9Imh0dHBzOi8vdHdpdHRlci5jb20vYmlvMnJkZiI+PGltZyBoZWlnaHQ9IjMwIiBzcmM9Imh0");
						result_tFixedFlowInput_6
								.append("dHA6Ly9tLmJpbzJyZGYub3JnL2ltYWdlL3R3aXR0ZXIucG5nIiAvPkBiaW8ycmRmPC9hPjwvaDM+");
						result_tFixedFlowInput_6
								.append("DQoJCQk8L3RkPg0KCQkJPHRkIHdpZHRoPSI2MCUiPiZuYnNwOzwvdGQ+DQoJCQk8dGQgd2lkdGg9");
						result_tFixedFlowInput_6
								.append("IjEwMCUiPjxhIGhyZWY9Imh0dHA6Ly9ncm91cHMuZ29vZ2xlLmNvbS9ncm91cC9iaW8ycmRmIj5T");
						result_tFixedFlowInput_6
								.append("ZW5kIHlvdXIgY29tbWVudHMgdG8gdGhlIHByb2plY3QgdGVhbTwvYT48L3RkPg0KCQk8L3RyPg0K");
						result_tFixedFlowInput_6
								.append("CTwvdGJvZHk+DQo8L3RhYmxlPg0KPC9ib2R5Pg0KPC9odG1sPg0K");
						String originalFileContent_tFixedFlowInput_6 = "";
						try {
							originalFileContent_tFixedFlowInput_6 = new String(
									(new sun.misc.BASE64Decoder()).decodeBuffer(result_tFixedFlowInput_6
						...
						for (int i_tFixedFlowInput_6 = 0; i_tFixedFlowInput_6 < 1; i_tFixedFlowInput_6++) {
							...
							java.io.InputStream ins_tFixedFlowInput_6 = new java.io.ByteArrayInputStream(
									originalFileContent_tFixedFlowInput_6
											.getBytes(utf8Charset));
							org.talend.fileprocess.FileInputDelimited fid_tFixedFlowInput_6 = new org.talend.fileprocess.FileInputDelimited(
									ins_tFixedFlowInput_6, utf8Charset, "&&&",
									"~~~", true, 0, 0, -1, -1, false);

							while (fid_tFixedFlowInput_6.nextRecord()) {
								nb_line_tFixedFlowInput_6++;
								row2 = new row2Struct();

								if (0 < fid_tFixedFlowInput_6
										.getColumnsCountOfCurrentRow()) {
									String colContent = fid_tFixedFlowInput_6
											.get(0);
						...
						end_Hash.put("tFixedFlowInput_6",
								System.currentTimeMillis());
					...
					if (nsid != null) {
						...
						{ // start of Var scope
							...
							// # Output table : 'nsid_virtuoso'
							// # Filter conditions
							if (

							row12.Accept.indexOf("text/html") != -1

							) {
								nsid_virtuoso_tmp.request = row12.request;
								nsid_virtuoso_tmp.ns = row12.ns;
								nsid_virtuoso_tmp.id = row12.id;
								nsid_virtuoso_tmp.Accept = row12.Accept;
								nsid_virtuoso = nsid_virtuoso_tmp;
							} // closing filter/reject

							// # Output table : 'nsid_accept'
							// # Filter conditions
							if (
							...
							row12.Accept.indexOf("text/html") == -1
								...
								nsid_accept_tmp.request = row12.request;
								nsid_accept_tmp.ns = row12.ns;
								nsid_accept_tmp.id = row12.id;
								nsid_accept_tmp.Accept = row12.Accept;
								nsid_accept = nsid_accept_tmp;
							} // closing filter/reject
								// ###############################
						 ...
						 * [tMap_2 main ] stop
						 */
						// Start of branch "nsid_virtuoso"
						if (nsid_virtuoso != null) {
							...
							globalMap.put("nsid_virtuoso.request",
									nsid_virtuoso.request);
							nb_line_tFlowToIterate_4++;
							globalMap.put("nsid_virtuoso.ns", nsid_virtuoso.ns);
							nb_line_tFlowToIterate_4++;
							globalMap.put("nsid_virtuoso.id", nsid_virtuoso.id);
							nb_line_tFlowToIterate_4++;
							globalMap.put("nsid_virtuoso.Accept",
									nsid_virtuoso.Accept);
							nb_line_tFlowToIterate_4++;
							 ...
							 */
							NB_ITERATE_tSparqlSelectRequest_4++;
							iterateLoop++;
							...
							start_Hash.put("tRESTResponse_2",
									System.currentTimeMillis());
							...
							/**
							 * [tSparqlSelectRequest_4 begin ] start
							 */

							ok_Hash.put("tSparqlSelectRequest_4", false);
							start_Hash.put("tSparqlSelectRequest_4",
									System.currentTimeMillis());

							currentComponent = "tSparqlSelectRequest_4";

							int tos_count_tSparqlSelectRequest_4 = 0;

							String URL_string_tSparqlSelectRequest_4;

							URL_string_tSparqlSelectRequest_4 = "http://dataset.bio2rdf.org/sparql"
							...
							java.net.URL url_tSparqlSelectRequest_4 = new java.net.URL(
									URL_string_tSparqlSelectRequest_4);

							java.net.HttpURLConnection urlConn_tSparqlSelectRequest_4 = (java.net.HttpURLConnection) url_tSparqlSelectRequest_4
									.openConnection();
							urlConn_tSparqlSelectRequest_4
									.setRequestMethod("GET");
							urlConn_tSparqlSelectRequest_4.setDoOutput(true);
							urlConn_tSparqlSelectRequest_4.setDoInput(true);
							urlConn_tSparqlSelectRequest_4.setUseCaches(false);

							urlConn_tSparqlSelectRequest_4.connect();

							byte[] buffer_tSparqlSelectRequest_4 = new byte[1024];
							int bos_buffer_tSparqlSelectRequest_4 = 0;

							StringBuilder sb_tSparqlSelectRequest_4 = new StringBuilder();

							if (java.net.HttpURLConnection.HTTP_OK == (urlConn_tSparqlSelectRequest_4
									.getResponseCode())) {
								java.io.InputStream bis_tSparqlSelectRequest_4 = new java.io.BufferedInputStream(
										urlConn_tSparqlSelectRequest_4
												.getInputStream());

								while ((bos_buffer_tSparqlSelectRequest_4 = bis_tSparqlSelectRequest_4
										.read(buffer_tSparqlSelectRequest_4)) != -1) {
									...
									sb_tSparqlSelectRequest_4
											.append(new String(
													buffer_tSparqlSelectRequest_4,
													0,
													bos_buffer_tSparqlSelectRequest_4));
								}
								bis_tSparqlSelectRequest_4.close();

							} else {
								System.err
										.println(urlConn_tSparqlSelectRequest_4
												.getResponseCode()
												+ " "
												+ urlConn_tSparqlSelectRequest_4
														.getResponseMessage());
							...
							urlConn_tSparqlSelectRequest_4.disconnect();

							java.util.ArrayList<String> queryKeys_tSparqlSelectRequest_4 = new java.util.ArrayList<String>();
							// ArrayList that contain the key value of the query
							// sorted correctly

							org.json.JSONObject jsonObj_tSparqlSelectRequest_4 = new org.json.JSONObject(
									sb_tSparqlSelectRequest_4.toString());

							org.json.JSONArray jsonKeysArray_tSparqlSelectRequest_4 = jsonObj_tSparqlSelectRequest_4
									.getJSONObject("head").getJSONArray("vars");
							for (int k_tSparqlSelectRequest_4 = 0; k_tSparqlSelectRequest_4 < jsonKeysArray_tSparqlSelectRequest_4
									.length(); k_tSparqlSelectRequest_4++) {
								queryKeys_tSparqlSelectRequest_4
										.add(jsonKeysArray_tSparqlSelectRequest_4
												.getString(k_tSparqlSelectRequest_4));
							}

							java.util.Iterator<String> queryKeysIterator_tSparqlSelectRequest_4;
							int i_tSparqlSelectRequest_4;
							int nb_line_tSparqlSelectRequest_4 = 0;

							org.json.JSONArray jsonArray_tSparqlSelectRequest_4 = jsonObj_tSparqlSelectRequest_4
									.getJSONObject("results").getJSONArray(
											"bindings");
							for (i_tSparqlSelectRequest_4 = 0; i_tSparqlSelectRequest_4 < jsonArray_tSparqlSelectRequest_4
									.length(); i_tSparqlSelectRequest_4++) {

								/**
								 * [tSparqlSelectRequest_4 begin ] stop
								 */
								/**
								 * [tSparqlSelectRequest_4 main ] start
								 */

								currentComponent = "tSparqlSelectRequest_4";

								queryKeysIterator_tSparqlSelectRequest_4 = queryKeys_tSparqlSelectRequest_4
										.iterator();

								if (queryKeysIterator_tSparqlSelectRequest_4
										.hasNext()) {
									try {
										row11.sparql = jsonArray_tSparqlSelectRequest_4
												.getJSONObject(
														i_tSparqlSelectRequest_4)
												.getJSONObject(
														queryKeysIterator_tSparqlSelectRequest_4
																.next())
												.getString("value");
									} catch (org.json.JSONException e_tSparqlSelectRequest_4) {
										row11.sparql = "";
									}
								}

								tos_count_tSparqlSelectRequest_4++;

								/**
								 * [tSparqlSelectRequest_4 main ] stop
								 */
								...
								{ // start of Var scope
									...
									copyOfout1_tmp.string = "<html><head><meta http-equiv=\"refresh\" content=\"0; url="
											+ row11.sparql
											+ "\" /> </head></html>";
								...
								if (copyOfout1 != null) {
									...
									String searchStr_tReplace_3_1 = "$NS$" + "";
									row27.string = StringUtils
											.replaceAllStrictly(row27.string,
													searchStr_tReplace_3_1,
													row12.ns + "", false, false);
									String searchStr_tReplace_3_2 = "$ID$" + "";
									row27.string = StringUtils
											.replaceAllStrictly(row27.string,
									...
									if (globalMap.containsKey("restResponse")) {
										...
										restProviderResponse_tRESTResponse_2 = row28.string;
								...
								/**
								 * [tSparqlSelectRequest_4 end ] start
								 */

								currentComponent = "tSparqlSelectRequest_4";

								nb_line_tSparqlSelectRequest_4++;
							}

							globalMap.put("tSparqlSelectRequest_4_NB_LINE",
									nb_line_tSparqlSelectRequest_4);

							ok_Hash.put("tSparqlSelectRequest_4", true);
							end_Hash.put("tSparqlSelectRequest_4",
									System.currentTimeMillis());

							/**
							 * [tSparqlSelectRequest_4 end ] stop
							 */
						...
						} // End of branch "nsid_virtuoso"

						// Start of branch "nsid_accept"
						if (nsid_accept != null) {
							...
							globalMap.put("nsid_accept.request",
									nsid_accept.request);
							nb_line_tFlowToIterate_14++;
							globalMap.put("nsid_accept.ns", nsid_accept.ns);
							nb_line_tFlowToIterate_14++;
							globalMap.put("nsid_accept.id", nsid_accept.id);
							nb_line_tFlowToIterate_14++;
							globalMap.put("nsid_accept.Accept",
									nsid_accept.Accept);
							nb_line_tFlowToIterate_14++;
							 ...
							 */
							NB_ITERATE_tSparqlSelectRequest_5++;
							iterateLoop++;
							...
							start_Hash.put("tFlowToIterate_15",
									System.currentTimeMillis());
							...
							/**
							 * [tReplace_7 begin ] start
							 */

							ok_Hash.put("tReplace_7", false);
							start_Hash.put("tReplace_7",
									System.currentTimeMillis());

							currentComponent = "tReplace_7";
							...
							/**
							 * [tSparqlSelectRequest_5 begin ] start
							 */

							ok_Hash.put("tSparqlSelectRequest_5", false);
							start_Hash.put("tSparqlSelectRequest_5",
									System.currentTimeMillis());

							currentComponent = "tSparqlSelectRequest_5";

							int tos_count_tSparqlSelectRequest_5 = 0;

							String URL_string_tSparqlSelectRequest_5;

							URL_string_tSparqlSelectRequest_5 = context.database_endpoint
									+ "?default-graph-uri=&query="
									+ java.net.URLEncoder
											.encode("select ?sparql  where { <http://bio2rdf.org/namespace:"
													+ row12.ns
							...
							java.net.URL url_tSparqlSelectRequest_5 = new java.net.URL(
									URL_string_tSparqlSelectRequest_5);

							java.net.HttpURLConnection urlConn_tSparqlSelectRequest_5 = (java.net.HttpURLConnection) url_tSparqlSelectRequest_5
									.openConnection();
							urlConn_tSparqlSelectRequest_5
									.setRequestMethod("GET");
							urlConn_tSparqlSelectRequest_5.setDoOutput(true);
							urlConn_tSparqlSelectRequest_5.setDoInput(true);
							urlConn_tSparqlSelectRequest_5.setUseCaches(false);

							urlConn_tSparqlSelectRequest_5.connect();

							byte[] buffer_tSparqlSelectRequest_5 = new byte[1024];
							int bos_buffer_tSparqlSelectRequest_5 = 0;

							StringBuilder sb_tSparqlSelectRequest_5 = new StringBuilder();

							if (java.net.HttpURLConnection.HTTP_OK == (urlConn_tSparqlSelectRequest_5
									.getResponseCode())) {
								java.io.InputStream bis_tSparqlSelectRequest_5 = new java.io.BufferedInputStream(
										urlConn_tSparqlSelectRequest_5
												.getInputStream());

								while ((bos_buffer_tSparqlSelectRequest_5 = bis_tSparqlSelectRequest_5
										.read(buffer_tSparqlSelectRequest_5)) != -1) {
									// Then the table of bytes and its size are
									// used to generate a string
									// which is added to a string builder that
									// will contain the whole response
									sb_tSparqlSelectRequest_5
											.append(new String(
													buffer_tSparqlSelectRequest_5,
													0,
													bos_buffer_tSparqlSelectRequest_5));
								}
								bis_tSparqlSelectRequest_5.close();

							} else {
								System.err
										.println(urlConn_tSparqlSelectRequest_5
												.getResponseCode()
												+ " "
												+ urlConn_tSparqlSelectRequest_5
														.getResponseMessage());
							...
							urlConn_tSparqlSelectRequest_5.disconnect();

							java.util.ArrayList<String> queryKeys_tSparqlSelectRequest_5 = new java.util.ArrayList<String>();
							// ArrayList that contain the key value of the query
							// sorted correctly

							org.json.JSONObject jsonObj_tSparqlSelectRequest_5 = new org.json.JSONObject(
									sb_tSparqlSelectRequest_5.toString());

							org.json.JSONArray jsonKeysArray_tSparqlSelectRequest_5 = jsonObj_tSparqlSelectRequest_5
									.getJSONObject("head").getJSONArray("vars");
							for (int k_tSparqlSelectRequest_5 = 0; k_tSparqlSelectRequest_5 < jsonKeysArray_tSparqlSelectRequest_5
									.length(); k_tSparqlSelectRequest_5++) {
								queryKeys_tSparqlSelectRequest_5
										.add(jsonKeysArray_tSparqlSelectRequest_5
												.getString(k_tSparqlSelectRequest_5));
							}

							java.util.Iterator<String> queryKeysIterator_tSparqlSelectRequest_5;
							int i_tSparqlSelectRequest_5;
							int nb_line_tSparqlSelectRequest_5 = 0;

							org.json.JSONArray jsonArray_tSparqlSelectRequest_5 = jsonObj_tSparqlSelectRequest_5
									.getJSONObject("results").getJSONArray(
											"bindings");
							for (i_tSparqlSelectRequest_5 = 0; i_tSparqlSelectRequest_5 < jsonArray_tSparqlSelectRequest_5
									.length(); i_tSparqlSelectRequest_5++) {

								/**
								 * [tSparqlSelectRequest_5 begin ] stop
								 */
								/**
								 * [tSparqlSelectRequest_5 main ] start
								 */

								currentComponent = "tSparqlSelectRequest_5";

								queryKeysIterator_tSparqlSelectRequest_5 = queryKeys_tSparqlSelectRequest_5
										.iterator();

								if (queryKeysIterator_tSparqlSelectRequest_5
										.hasNext()) {
									try {
										row35.sparql = jsonArray_tSparqlSelectRequest_5
												.getJSONObject(
														i_tSparqlSelectRequest_5)
												.getJSONObject(
														queryKeysIterator_tSparqlSelectRequest_5
																.next())
												.getString("value");
									} catch (org.json.JSONException e_tSparqlSelectRequest_5) {
										row35.sparql = "";
									}
								}

								tos_count_tSparqlSelectRequest_5++;

								/**
								 * [tSparqlSelectRequest_5 main ] stop
								 */

								/**
								 * [tReplace_7 main ] start
								 */

								currentComponent = "tReplace_7";

								String searchStr_tReplace_7_1 = "$NSID$" + "";
								row35.sparql = StringUtils.replaceAllStrictly(
										row35.sparql, searchStr_tReplace_7_1,
										context.ns + ":" + context.id + "",
										false, false);
								String searchStr_tReplace_7_2 = "$ID$" + "";
								row35.sparql = StringUtils.replaceAllStrictly(
										row35.sparql, searchStr_tReplace_7_2,
										context.id + "", false, false);
								String searchStr_tReplace_7_3 = "$NS$" + "";
								row35.sparql = StringUtils.replaceAllStrictly(
								...
								tos_count_tReplace_7++;

								/**
								 * [tReplace_7 main ] stop
								 */
								...
								globalMap.put("row37.sparql", row37.sparql);
								...
								start_Hash.put("tRESTResponse_10",
										System.currentTimeMillis());
								...
								for (String[] item_tRunJob_4 : childReturn_tRunJob_4) {
									...
									if (globalMap.containsKey("restResponse")) {
										...
										Integer restProviderStatusCode_tRESTResponse_10 = 200;

										Object restProviderResponse_tRESTResponse_10 = null;
										restProviderResponse_tRESTResponse_10 = row38.string;
										if (null != row38.body) {
											restProviderResponse_tRESTResponse_10 = row38.body
													.getDocument();
										}
								...
								/**
								 * [tSparqlSelectRequest_5 end ] start
								 */

								currentComponent = "tSparqlSelectRequest_5";

								nb_line_tSparqlSelectRequest_5++;
							}

							globalMap.put("tSparqlSelectRequest_5_NB_LINE",
									nb_line_tSparqlSelectRequest_5);

							ok_Hash.put("tSparqlSelectRequest_5", true);
							end_Hash.put("tSparqlSelectRequest_5",
									System.currentTimeMillis());

							/**
							 * [tSparqlSelectRequest_5 end ] stop
							 */

							/**
							 * [tReplace_7 end ] start
							 */
							...
							end_Hash.put("tFlowToIterate_15",
									System.currentTimeMillis());
					...
					if (nsid_format != null) {
						...
						if (java.net.HttpURLConnection.HTTP_OK == (urlConn_tSparqlSelectRequest_6
							...
							while ((bos_buffer_tSparqlSelectRequest_6 = bis_tSparqlSelectRequest_6
								...
								// Then the table of bytes and its size are used
								// to generate a string
								// which is added to a string builder that will
								// contain the whole response
								sb_tSparqlSelectRequest_6.append(new String(
										buffer_tSparqlSelectRequest_6, 0,
										bos_buffer_tSparqlSelectRequest_6));
							}
							bis_tSparqlSelectRequest_6.close();

						} else {
							System.err.println(urlConn_tSparqlSelectRequest_6
									.getResponseCode()
									+ " "
									+ urlConn_tSparqlSelectRequest_6
											.getResponseMessage());
						...
						org.json.JSONObject jsonObj_tSparqlSelectRequest_6 = new org.json.JSONObject(
								sb_tSparqlSelectRequest_6.toString());

						org.json.JSONArray jsonKeysArray_tSparqlSelectRequest_6 = jsonObj_tSparqlSelectRequest_6
								.getJSONObject("head").getJSONArray("vars");
						...
						org.json.JSONArray jsonArray_tSparqlSelectRequest_6 = jsonObj_tSparqlSelectRequest_6
								.getJSONObject("results").getJSONArray(
										"bindings");
					...
					if (page != null) {
						...
						if (java.net.HttpURLConnection.HTTP_OK == (urlConn_tSparqlSelectRequest_3
							...
							while ((bos_buffer_tSparqlSelectRequest_3 = bis_tSparqlSelectRequest_3
								...
								// which is added to a string builder that will
								// contain the whole response
								sb_tSparqlSelectRequest_3.append(new String(
										buffer_tSparqlSelectRequest_3, 0,
										bos_buffer_tSparqlSelectRequest_3));
							}
							bis_tSparqlSelectRequest_3.close();

						} else {
							System.err.println(urlConn_tSparqlSelectRequest_3
									.getResponseCode()
									+ " "
									+ urlConn_tSparqlSelectRequest_3
											.getResponseMessage());
						...
						org.json.JSONObject jsonObj_tSparqlSelectRequest_3 = new org.json.JSONObject(
								sb_tSparqlSelectRequest_3.toString());

						org.json.JSONArray jsonKeysArray_tSparqlSelectRequest_3 = jsonObj_tSparqlSelectRequest_3
								.getJSONObject("head").getJSONArray("vars");
						...
						org.json.JSONArray jsonArray_tSparqlSelectRequest_3 = jsonObj_tSparqlSelectRequest_3
								.getJSONObject("results").getJSONArray(
										"bindings");
					...
					if (test != null) {
						...
						org.json.JSONObject jsonObj_tSparqlSelectRequest_1 = new org.json.JSONObject(
								sb_tSparqlSelectRequest_1.toString());

						org.json.JSONArray jsonKeysArray_tSparqlSelectRequest_1 = jsonObj_tSparqlSelectRequest_1
								.getJSONObject("head").getJSONArray("vars");
						...
						org.json.JSONArray jsonArray_tSparqlSelectRequest_1 = jsonObj_tSparqlSelectRequest_1
								.getJSONObject("results").getJSONArray(
										"bindings");
					...
					if (test_namespace != null) {
						...
						if (java.net.HttpURLConnection.HTTP_OK == (urlConn_tSparqlSelectRequest_2
							...
							while ((bos_buffer_tSparqlSelectRequest_2 = bis_tSparqlSelectRequest_2
								...
								// which is added to a string builder that will
								// contain the whole response
								sb_tSparqlSelectRequest_2.append(new String(
										buffer_tSparqlSelectRequest_2, 0,
										bos_buffer_tSparqlSelectRequest_2));
							}
							bis_tSparqlSelectRequest_2.close();

						} else {
							System.err.println(urlConn_tSparqlSelectRequest_2
									.getResponseCode()
									+ " "
									+ urlConn_tSparqlSelectRequest_2
											.getResponseMessage());
						...
						org.json.JSONObject jsonObj_tSparqlSelectRequest_2 = new org.json.JSONObject(
								sb_tSparqlSelectRequest_2.toString());

						org.json.JSONArray jsonKeysArray_tSparqlSelectRequest_2 = jsonObj_tSparqlSelectRequest_2
								.getJSONObject("head").getJSONArray("vars");
						...
						org.json.JSONArray jsonArray_tSparqlSelectRequest_2 = jsonObj_tSparqlSelectRequest_2
								.getJSONObject("results").getJSONArray(
										"bindings");
					...
					end_Hash.put("tFlowToIterate_14",
							System.currentTimeMillis());
			...
			try {
				...
				/**
				 * [tSparqlSelectRequest_4 finally ] start
				 */

				currentComponent = "tSparqlSelectRequest_4";

				/**
				 * [tSparqlSelectRequest_4 finally ] stop
				 */
				...
				/**
				 * [tSparqlSelectRequest_5 finally ] start
				 */

				currentComponent = "tSparqlSelectRequest_5";

				/**
				 * [tSparqlSelectRequest_5 finally ] stop
				 */

				/**
				 * [tReplace_7 finally ] start
				 */

				currentComponent = "tReplace_7";

				/**
				 * [tReplace_7 finally ] stop
				 */
		...
		try {
			...
			java.io.InputStream inContext = REST_Bio2RDF_9000.class
					.getClassLoader().getResourceAsStream(
							"bio2rdf/rest_bio2rdf_9000_2_3/contexts/"
