...
package bio2rdf.rest_bio2rdf_9000_2_6;
 ...
 * Description: francois.belleau@bio2rdf.org & vincent.emonet@gmail.com
 20140829 VE 2.6 Use Sesame components, handle nquads and graphs
 20140507 VE 2.5 Handle Json-LD and TriG lang
...
public class REST_Bio2RDF_9000 implements TalendJob {
	...
	public class ContextProperties extends java.util.Properties {
		...
		public void synchronizeContext() {
			...
			if (mimeType != null) {
				...
				this.setProperty("mimeType", mimeType.toString());

			}

			if (outputFormat != null) {

				this.setProperty("outputFormat", outputFormat.toString());
	...
	private final String jobVersion = "2.6";
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				try {
					...
					if (nsid != null) {
						...
						context.mimeType = row12.Accept;
						context.format = BioUtil
								.getFormatFromMime(context.mimeType);
						System.out.println(context.format);
						System.out.println(context.mimeType);

						// EN ATTENDANT DE FAIRE UN RENDER HTML CORRECT
						/*
						 * if (row12.Accept.equals("text/html")) {
						 * context.format = "application/rdf+xml";
						 * context.mimeType = "application/rdf+xml";
						 * row12.Accept = "application/rdf+xml"; }
						 */
						if (row12.Accept.equals("text/html")) {
							context.format = "nquads";
						...
						for (String[] item_tRunJob_5 : childReturn_tRunJob_5) {
							...
							if (globalMap.containsKey("restResponse")) {
								...
								restProviderResponseHeaders_tRESTResponse_9
										.put("Content-Type", context.mimeType);
					...
					if (nsid_format != null) {
						...
						context.format = row6.format;
						context.mimeType = BioUtil
								.getMimeFromFormat(row6.format);
					...
					if (method_nsid != null) {
						...
						context.mimeType = BioUtil
								.getMimeFromFormat(row63.format);
						context.format = row63.format;
						nb_line_tJavaRow_18++;
						...
						parentContextMap_tRunJob_10.put("mimeType",
								context.mimeType);

						parentContextMap_tRunJob_10.put("outputFormat",
					...
					if (method_uri != null) {
						...
						context.mimeType = BioUtil
								.getMimeFromFormat(row66.format);
						context.format = row66.format;
						...
						parentContextMap_tRunJob_12.put("mimeType",
								context.mimeType);

						parentContextMap_tRunJob_12.put("outputFormat",
								context.outputFormat);
					...
					if (method_query != null) {
						...
						context.mimeType = BioUtil
								.getMimeFromFormat(row64.format);
						context.format = row64.format;
						...
						parentContextMap_tRunJob_9.put("mimeType",
								context.mimeType);

						parentContextMap_tRunJob_9.put("outputFormat",
								context.outputFormat);
					...
					if (method_linksns != null) {
						...
						context.mimeType = BioUtil
								.getMimeFromFormat(row3.format);
						context.format = row3.format;
						nb_line_tJavaRow_1++;
						...
						parentContextMap_tRunJob_1.put("mimeType",
								context.mimeType);

						parentContextMap_tRunJob_1.put("outputFormat",
								context.outputFormat);
					...
					if (method_searchns != null) {
						...
						context.mimeType = BioUtil
								.getMimeFromFormat(row23.format);
						context.format = row23.format;
						...
						parentContextMap_tRunJob_2.put("mimeType",
								context.mimeType);

						parentContextMap_tRunJob_2.put("outputFormat",
								context.outputFormat);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = REST_Bio2RDF_9000.class
					.getClassLoader().getResourceAsStream(
							"bio2rdf/rest_bio2rdf_9000_2_6/contexts/"
			...
			context.mimeType = (String) context.getProperty("mimeType");
			context.outputFormat = (String) context.getProperty("outputFormat");
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			...
			if (parentContextMap.containsKey("mimeType")) {
				context.mimeType = (String) parentContextMap.get("mimeType");
			}
			if (parentContextMap.containsKey("outputFormat")) {
				context.outputFormat = (String) parentContextMap
						.get("outputFormat");
			}
		}
...
/************************************************************************************************
 * 590521 characters generated by Talend Open Studio for ESB on the 29 août 2014
 * 16:28:20 EDT
 ************************************************************************************************/
