...
public class rdfxml_reader_converter implements TalendJob {
	...
	public void tRDF2RDF_2_error(java.lang.Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tHttpRequest_2Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				/**
				 * [tRDF2RDF_2 begin ] start
				 */

				ok_Hash.put("tRDF2RDF_2", false);
				start_Hash.put("tRDF2RDF_2", System.currentTimeMillis());
				...
				if (ntriples != null) {
					...
					if (not_jsonld != null) {
						...
						tos_count_tRDF2RDF_2++;

						/**
						 * [tRDF2RDF_2 main ] stop
						 */
				...
				/**
				 * [tRDF2RDF_2 end ] start
				 */

				currentComponent = "tRDF2RDF_2";

				globalMap.put("tRDF2RDF_2_NB_LINE", nb_line_tRDF2RDF_2);

				ok_Hash.put("tRDF2RDF_2", true);
				end_Hash.put("tRDF2RDF_2", System.currentTimeMillis());
			...
			try {
				...
				/**
				 * [tRDF2RDF_2 finally ] start
				 */

				currentComponent = "tRDF2RDF_2";

				/**
				 * [tRDF2RDF_2 finally ] stop
				 */
...
/************************************************************************************************
 * 73451 characters generated by Talend Open Studio for ESB on the 6 août 2014
 * 18:44:49 EDT
 ************************************************************************************************/
